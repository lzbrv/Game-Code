	...
	const TArray<TraceCharacterRoster::FTraceCharacterEntry>& GetCppTable()
	{
		static const TArray<TraceCharacterRoster::FTraceCharacterEntry> Table =
		{
			...
			},
			{
				...
				TEXT("WELL-TIMED SLIDE JUMPS GIVE 30% MORE OF THE MOMENTUM BOOST THAN ANYONE ELSE."),
				TEXT("PASSING OR THROWING THE CORE CLOAKS YOU FOR 3S - SEMI-TRANSPARENT AND HARD TO SEE "
				     "OR AIM AT."),
				TEXT("SNAP"),
